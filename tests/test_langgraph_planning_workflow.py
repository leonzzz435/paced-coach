    ...
    def minimal_valid_state(self) -> TrainingAnalysisState:
        return create_initial_state(
            ...
            training_data={
                ...
                "sources": {"strava": {"training_load_history": []}},
            },
            planning_context="",
            competitions=[],
            current_date={},
...
class TestWorkflowDataFlow:
    ...
    def test_planning_state_fields(self):
        ...
        for field in ["competitions", "current_date", "week_dates", "planning_context", "transition_context", "athlete_name"]:
            assert field in state

        for field in ["season_plan", "weekly_plan"]:
            assert field in state
