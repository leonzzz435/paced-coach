...
@pytest.fixture
def sample_training_data(sample_source_data):
    return {
        "generated_at_utc": "2024-01-02T00:00:00+00:00",
        "sources": {"strava": sample_source_data},
    }


@pytest.fixture
def sample_state(sample_training_data):
...
def test_state_creation(sample_training_data):
    ...
    assert state["training_data"] == sample_training_data
